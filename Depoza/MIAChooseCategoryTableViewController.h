...
@interface MIAChooseCategoryTableViewController : UITableViewController

@property (nonatomic, strong) NSArray *titles;
@property (nonatomic, strong) NSManagedObjectContext *managedObjectContext;
@property (nonatomic, copy) NSString *originalCategoryName;

@property (nonatomic, strong) id<MIAChooseCategoryTableViewControllerDelegate> delegate;
