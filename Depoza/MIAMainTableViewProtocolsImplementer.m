...
@interface MIAMainTableViewProtocolsImplementer ()

@end

@implementation MIAMainTableViewProtocolsImplementer
...
- (void)configureCell:(MIAMainViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    if (expense.descriptionOfExpense.length == 0) {
        ...
        cell.categoryLabelTopSpaceConstraint.constant = MIAIncreasedCategoryLabelTopSpaceValue;
    } else {
        cell.categoryLabelTopSpaceConstraint.constant = MIADefaultCategoryLabelTopSpaceValue;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    MIAMainViewCell *cell = (MIAMainViewCell *)[tableView dequeueReusableCellWithIdentifier:@"Cell"];
...
- (void)controller:(NSFetchedResultsController *)controller didChangeObject:(id)anObject atIndexPath:(NSIndexPath *)indexPath forChangeType:(NSFetchedResultsChangeType)type newIndexPath:(NSIndexPath *)newIndexPath {
    ...
    switch(type) {
        ...
        case NSFetchedResultsChangeUpdate:
            [self configureCell:(MIAMainViewCell *)[tableView cellForRowAtIndexPath:indexPath] atIndexPath:indexPath];
            break;
