...
@interface MIAAllExpensesTableViewController () <NSFetchedResultsControllerDelegate, UISearchResultsUpdating, UISearchBarDelegate>
...
@implementation MIAAllExpensesTableViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([segue.identifier isEqualToString:@"MoreInfo"]) {
        MIAMoreInfoTableViewController *detailsViewController = (MIAMoreInfoTableViewController *)[segue destinationViewController];
        ...
        MIAAddExpenseViewController *controller = (MIAAddExpenseViewController *)segueNavigationController.topViewController;
...
- (void)tableView:(UITableView *)tableView accessoryButtonTappedForRowWithIndexPath:(NSIndexPath *)indexPath {
    ...
    MIAEditExpenseTableViewController *editExpenseViewController = [navigationController.viewControllers firstObject];
