...
#import "MIATodayViewController.h"
...
@interface MIATodayViewController () <NCWidgetProviding, UITableViewDataSource, UITableViewDelegate>

@property (weak, nonatomic) IBOutlet UITableView *tableView;
@property (weak, nonatomic) IBOutlet UILabel *noExpensesLabel;

@property (nonatomic, strong) MIAPersistence *persistence;
@property (nonatomic, copy) UpdateBlock updateBlock;

@end

@implementation MIATodayViewController {
    NSArray *_expenses;
...
- (void)viewDidLoad {
    ...
    _persistence = [MIAPersistence sharedInstance];
...
- (void)widgetPerformUpdateWithCompletionHandler:(void (^)(NCUpdateResult))completionHandler {
    ...
    if ([MIAFetch hasNewExpensesForTodayInManagedObjectContext:self.persistence.managedObjectContext]) {
        [self updateUserInterfaceWithUpdateResult:NCUpdateResultNewData];
